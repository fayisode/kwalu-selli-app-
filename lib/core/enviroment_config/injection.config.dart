...
import '../../modules/auth/domain/use_cases/create_new_account_use_case.dart'
    as _i8;
import '../../modules/auth/presentation/manager/bloc/register_bloc.dart' as _i9;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i8.CreateNewAccountUseCase>(
      () => _i8.CreateNewAccountUseCase(get<_i6.IAuthRepo>()));
  gh.factory<_i9.RegisterBloc>(
      () => _i9.RegisterBloc(get<_i8.CreateNewAccountUseCase>()));
  return get;
}

class _$DioInjectionModule extends _i10.DioInjectionModule {}
